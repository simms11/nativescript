...
android.app.job.JobService.extend("com.tns.notifications.MyJobService", {
    onStartJob: function(params) {       
        ...
        const mainIntent = new android.context.Intent(context, com.tns.NativeScriptActivity.class);
           
        // example for custom intent passing custom data via the broadcast receiver
        let intent = new android.context.Intent("customservice");
        ...
        const mNotificationManager = context.getSystemService(android.context.Context.NOTIFICATION_SERVICE);

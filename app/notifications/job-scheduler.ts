...
function scheduleJob(context) {
    ...
    let component = new android.context.ComponentName(context, com.tns.notifications.MyJobService.class);
    ...
    const jobScheduler = context.getSystemService(android.context.Context.JOB_SCHEDULER_SERVICE);
